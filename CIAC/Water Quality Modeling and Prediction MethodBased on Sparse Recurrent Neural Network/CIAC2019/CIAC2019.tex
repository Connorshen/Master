...
sustainable development of economy and society. In order to solve this problem 
efficiently, the rational planning 
...
tangent function as the activation function of 
...
in the matrix represents the connection weight among 
