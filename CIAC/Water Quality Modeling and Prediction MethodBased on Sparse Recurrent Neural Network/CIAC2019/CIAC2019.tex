...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\columnwidth]{RMS_error_for_SRNN}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.8\columnwidth]{Prediction_results_AN_and_DO}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\columnwidth]{Water_quality_rank_prediction_accuracy}
